...
/**
 * 实现原理: 主要是自定义实现OnPageChangeListener。在onPageScroll()方法中，获取当前滑块的位置，先执行scrollToChild()
 *  ,后调用invalidate()方法来使系统回调onDraw()方法。在onDraw()方法中，可以利用Canvas.drawLine()和drawRect()一系列方法
 *  来绘制指示器，分隔条，导航条背景等等。
 */
